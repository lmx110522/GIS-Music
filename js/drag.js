...
(function($) {
    ...
    Slider.prototype = {
        ...
        bindDragEvent: function() {
            ...
            function success() {
                var layui_btn  = $prog.parents('.layui-tab-item').find('.layui-btn');
                   layui_btn.css("pointer-events","all");
                   layui_btn.addClass('submit_btn')
                   layui_btn.removeClass("layui-btn-disabled");
                $prog.css({
